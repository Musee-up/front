        ...
        >
          <v-row justify="center">
            <nuxt-img
              :height="cols"
              :width="cols"
              class="rounded-circle" :src="photos[index]"></nuxt-img>
          </v-row>
          <v-row justify="center">
...
export default {
  data() {
    return {
      ...
      photos: {
        discovery: '/about/protection/discovery.png',
        patronage: '/about/protection/patronage.png',
        awareness: '/about/protection/awareness.png',
      },
    }
  },
  computed: {
