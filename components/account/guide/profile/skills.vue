...
export default {
  ...
  methods: {
    onChange() {
      const input = {
        workExperiences: this.skills.workExperiences.value,
        specialties: this.skills.specialties.value,
